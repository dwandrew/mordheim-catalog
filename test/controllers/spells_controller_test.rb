...
class SpellsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spell" do
    assert_difference('Spell.count') do
      post spells_url, params: { spell: { description: @spell.description, difficulty: @spell.difficulty, name: @spell.name, number: @spell.number, school: @spell.school } }
    end
  ...
  test "should update spell" do
    patch spell_url(@spell), params: { spell: { description: @spell.description, difficulty: @spell.difficulty, name: @spell.name, number: @spell.number, school: @spell.school } }
