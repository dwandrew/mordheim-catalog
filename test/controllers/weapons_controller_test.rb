...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { cost: @weapon.cost, name: @weapon.name, range: @weapon.range, strength: @weapon.strength } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { cost: @weapon.cost, name: @weapon.name, range: @weapon.range, strength: @weapon.strength } }
