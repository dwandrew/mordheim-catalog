...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { cost: @equipment.cost, description: @equipment.description, name: @equipment.name, rarity: @equipment.rarity } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { cost: @equipment.cost, description: @equipment.description, name: @equipment.name, rarity: @equipment.rarity } }
